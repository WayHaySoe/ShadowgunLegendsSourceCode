...
tal8_CFLAGS = -fobjc-arc
tal8_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG
...
tal8_FILES = Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

tal8_LIBRARIES += substrate

tal8_FRAMEWORKS = $(PROJ_COMMON_FRAMEWORKS)
# GO_EASY_ON_ME = 1
